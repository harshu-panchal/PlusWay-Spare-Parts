...
const SCRAPED_DIR = path.resolve(__dirname, '../../scraped_data/SUPER_ZX');
const BRAND_NAME = 'Acer';
const MODEL_NAME = 'Super ZX';
    ...
    try {
        ...
        for (const folder of productFolders) {
            ...
            for (const imgFile of imagesToUpload) {
                const url = await uploadToCloudinary(path.join(folderPath, imgFile), `plusway_spare_parts/ACER_SUPER_ZX`);
