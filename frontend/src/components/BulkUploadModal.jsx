  ...
  const downloadTemplate = async () => {
    try {
      ...
      const instructions = [
        ...
        ["5. colors: comma-separated -> Black,White,Gold (optional, colorVariants preferred)"],
        ["6. colorVariants *: REQUIRED — each variant carries its own SKU, price, stock."],
        ["   Format: colorName;sku;price;mrp;wholesalePrice;wholesaleMinQty;countInStock;img1,img2"],
        ...
        ["   Leave sku blank to auto-generate: Black;;4500;5500;3800;10;50;http://img1.jpg"],
        ...
        ["10. price, mrp, wholesalePrice, wholesaleMinQty, countInStock are set PER VARIANT inside colorVariants."],
        ["    There are no separate top-level price/stock/SKU columns — all carried by variants."],
        [""],
