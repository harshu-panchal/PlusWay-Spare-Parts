                                ...
                                {sections.map((section) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`w-full text-left px-3 py-2 rounded text-sm font-bold transition-colors flex items-center gap-2 ${activeSection === section.id
                        ...
                        <div className="prose prose-sm md:prose max-w-none">
                            ...
                            <div className="mb-8 pb-8 border-b border-gray-200">
                                <p className="text-gray-600 font-medium leading-relaxed">
                                    At PlusWay.com, we are committed to protecting your privacy
                            ...
                            <section id="rights" className="mb-10 scroll-mt-24">
                                ...
                                <div className="space-y-3 text-gray-600 font-medium">
                                    ...
                                    <p className="mt-4">
                                        ...
                                        <a
                                            href="mailto:privacy@plusway.com"
