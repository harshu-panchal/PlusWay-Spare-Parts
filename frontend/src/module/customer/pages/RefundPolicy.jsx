    ...
    const returnSteps = [
        {
            ...
            description: "Contact our support or use your order page to request a return",
        },
        {
            step: 2,
            title: "Approval",
        ...
        },
        {
            step: 3,
            title: "Ship Back",
            description: "Pack the item securely and ship it back using our provided label",
        },
        {
            step: 4,
