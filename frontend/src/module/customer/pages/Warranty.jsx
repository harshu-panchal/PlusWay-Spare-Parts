                        ...
                        <div className="bg-white rounded-xl shadow-md p-6 md:p-8">
                            ...
                            <div className="space-y-4 text-gray-600 font-medium text-sm">
                                ...
                                <div>
                                    ...
                                    <p>
                                        The warranty period begins from the date of delivery, not the
                        ...
                        <div className="bg-white rounded-xl shadow-md p-6">
                            ...
                            <div className="space-y-3 text-sm">
                                <div>
                                    ...
                                    <p className="text-gray-800 font-medium">warranty@plusway.com</p>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-800 font-medium">Mon-Sat: 9 AM - 7 PM</p>
                                </div>
                            </div>
                        </div>
